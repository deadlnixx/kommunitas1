...
```
usage: kommunitas edge [-h] [-v] [--logfile FILE] [-V] [-c PATH] [-d PATH]
...
```bash
kommunitas edge --stoplosses=-0.01,-0.1,-0.001 #min,max,step
```

### Advanced use of timerange

```bash
kommunitas edge --timerange=20181110-20181113
```
