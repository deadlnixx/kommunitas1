...
## Stop Loss On-Exchange/kommunitas
...
!!! Note
    Stoploss on exchange is only supported for bitmart (stop-loss-limit), Kraken (stop-loss-market, stop-loss-limit) and FTX (stop limit and stop-market) as of now.  
