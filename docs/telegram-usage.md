...
Choose the public name of your bot (e.x. `kommunitas bot`)

*BotFather response:*

> Good. Now let's choose a username for your bot. It must end in `bot`. Like this, for example: TetrisBot or tetris_bot.

Choose the name id of your bot and send it to the BotFather (e.g. "`My_own_kommunitas_bot`")
...
For the kommunitas configuration, you can then use the the full value (including `-` if it's there) as string:
...
kommunitas provides means to control the verbosity of your telegram bot.
