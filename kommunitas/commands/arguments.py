...
from kommunitas.commands.cli_options import AVAILABLE_CLI_OPTIONS
from kommunitas.constants import DEFAULT_CONFIG
...
class Arguments:
    ...
    def _build_subcommands(self) -> None:
        ...
        from kommunitas.commands import (start_backtesting, start_convert_data, start_create_userdir,
