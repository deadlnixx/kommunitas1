...
from kommunitas.configuration.directory_operations import copy_sample_files, create_userdata_dir
...
from kommunitas.misc import render_template, render_template_with_fallback
...
def get_ui_download_url() -> Tuple[str, str]:
    base_url = 'https://api.github.com/repos/kommunitas/frequi/'
