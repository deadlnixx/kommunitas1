...
from kommunitas.constants import USERPATH_HYPEROPTS, USERPATH_STRATEGIES
from kommunitas.enums import RunMode
from kommunitas.exceptions import OperationalException
from kommunitas.exchange import market_is_active, validate_exchanges
from kommunitas.misc import parse_db_uri_for_logging, plural
...
def start_list_exchanges(args: Dict[str, Any]) -> None:
    ...
    if args['print_one_column']:
        ...
        if args['list_exchanges_all']:
            ...
            print("Exchanges available for kommunitas:")
...
def start_show_trades(args: Dict[str, Any]) -> None:
    ...
    from kommunitas.persistence import Trade, init_db
    config = setup_utils_configuration(args, RunMode.UTIL_NO_EXCHANGE)
