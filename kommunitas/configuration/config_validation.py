...
def _extend_validator(validator_class):
    """
    Extended validator for the kommunitas configuration JSON Schema.
...
kommunitasValidator = _extend_validator(Draft4Validator)
...
def validate_config_schema(conf: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        kommunitasValidator(conf_schema).validate(conf)
        return conf
