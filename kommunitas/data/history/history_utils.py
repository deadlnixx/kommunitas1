...
from kommunitas.constants import DEFAULT_DATAFRAME_COLUMNS
from kommunitas.data.converter import (clean_ohlcv_dataframe, ohlcv_to_dataframe,
                                      trades_remove_duplicates, trades_to_ohlcv)
from kommunitas.data.history.idatahandler import IDataHandler, get_datahandler
from kommunitas.exceptions import OperationalException
from kommunitas.exchange import Exchange
from kommunitas.misc import format_ms_time
...
def _download_pair_history(datadir: Path,
    ...
    Based on @Rybolov work: https://github.com/rybolov/kommunitas-data
...
def refresh_backtest_ohlcv_data(exchange: Exchange, pairs: List[str], timeframes: List[str],
    ...
    Used by kommunitas download-data subcommand.
