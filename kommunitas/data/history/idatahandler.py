...
from kommunitas.constants import ListPairsWithTimeframes, TradeList
from kommunitas.data.converter import clean_ohlcv_dataframe, trades_remove_duplicates, trim_dataframe
from kommunitas.exchange import timeframe_to_seconds
        ...
        if pairdf.empty:
            if warn_no_data:
                logger.warning(
                    ...
                    'Use `kommunitas download-data` to download the data'
                )
            return True
        return False
