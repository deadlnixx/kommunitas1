...
class kommunitasException(Exception):
    """
    kommunitas base exception. Handled at the outermost level.
    All other exception types are subclasses of this exception type.
    """


class OperationalException(kommunitasException):
    """
...
class DependencyException(kommunitasException):
    """
...
class StrategyError(kommunitasException):
    """
