...
from kommunitas.constants import DEFAULT_AMOUNT_RESERVE_PERCENT, ListPairsWithTimeframes
from kommunitas.data.converter import ohlcv_to_dataframe, trades_dict_to_list
from kommunitas.exceptions import (DDosProtection, ExchangeError, InsufficientFundsError,
                                  InvalidOrderException, OperationalException, PricingError,
                                  RetryableOrderError, TemporaryError)
from kommunitas.exchange.common import (API_FETCH_ORDER_RETRY_COUNT, BAD_EXCHANGES,
                                       EXCHANGE_HAS_OPTIONAL, EXCHANGE_HAS_REQUIRED, retrier,
                                       retrier_async)
from kommunitas.misc import deep_merge_dicts, safe_value_fallback2
...
class Exchange:
    ...
    def market_is_tradable(self, market: Dict[str, Any]) -> bool:
        """
        Check if the market symbol is tradable by kommunitas.
    ...
    def validate_timeframes(self, timeframe: Optional[str]) -> None:
        ...
        if timeframe and timeframe_to_minutes(timeframe) < 1:
            raise OperationalException("Timeframes < 1m are currently not supported by kommunitas.")
    ...
    async def _async_get_trade_history_id(self, pair: str,
        ...
        if not from_id:
            ...
            # of up to an hour.
            # e.g. bitmart returns the "last 1000" candles within a 1h time interval
...
def is_exchange_officially_supported(exchange_name: str) -> bool:
    return exchange_name in ['bittrex', 'bitmart', 'kraken']
