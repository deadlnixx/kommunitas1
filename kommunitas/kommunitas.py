"""
kommunitas is the main module of this bot. It contains the class kommunitas()
"""
import copy
import logging
import traceback
...
from kommunitas import __version__, constants
from kommunitas.configuration import validate_config_consistency
from kommunitas.data.converter import order_book_to_dataframe
from kommunitas.data.dataprovider import DataProvider
from kommunitas.edge import Edge
from kommunitas.enums import RPCMessageType, SellType, State
from kommunitas.exceptions import (DependencyException, ExchangeError, InsufficientFundsError,
                                  InvalidOrderException, PricingError)
from kommunitas.exchange import timeframe_to_minutes, timeframe_to_seconds
from kommunitas.misc import safe_value_fallback, safe_value_fallback2
from kommunitas.mixins import LoggingMixin
from kommunitas.persistence import Order, PairLocks, Trade, cleanup_db, init_db
from kommunitas.plugins.pairlistmanager import PairListManager
from kommunitas.plugins.protectionmanager import ProtectionManager
from kommunitas.resolvers import ExchangeResolver, StrategyResolver
from kommunitas.rpc import RPCManager
from kommunitas.strategy.interface import IStrategy, SellCheckTuple
from kommunitas.strategy.strategy_wrapper import strategy_safe_wrapper
from kommunitas.wallets import Wallets


logger = logging.getLogger(__name__)


class kommunitasBot(LoggingMixin):
    """
    kommunitas is the main class of the bot.
    ...
    def __init__(self, config: Dict[str, Any]) -> None:
        ...
        logger.info('Starting kommunitas %s', __version__)
        ...
        # initialization, even before kommunitasbot has a chance to start its throttling,
        # so anything in the kommunitasbot instance should be ready (initialized), including
    ...
    def process(self) -> None:
        ...
        # Without this, kommunitas my try to recreate stoploss_on_exchange orders
...
#
    ...
    def get_real_amount(self, trade: Trade, order: Dict) -> float:
        ...
        Necessary for exchanges which charge fees in base currency (e.g. bitmart)
