"""
Various tool function for kommunitas and scripts
"""
import gzip
import logging
import re
...
from kommunitas.constants import DECIMAL_PER_COIN_FALLBACK, DECIMALS_PER_COIN
...
def render_template(templatefile: str, arguments: dict = {}) -> str:
    ...
    env = Environment(
        loader=PackageLoader('kommunitas', 'templates'),
