...
from kommunitas.enums import BacktestState
from kommunitas.exceptions import DependencyException
from kommunitas.rpc.api_server.api_schemas import BacktestRequest, BacktestResponse
from kommunitas.rpc.api_server.deps import get_config
from kommunitas.rpc.api_server.webserver import ApiServer
from kommunitas.rpc.rpc import RPCException
...
async def api_start_backtest(bt_settings: BacktestRequest, background_tasks: BackgroundTasks,
    ...
    def run_backtest():
        from kommunitas.optimize.optimize_reports import generate_backtest_stats
