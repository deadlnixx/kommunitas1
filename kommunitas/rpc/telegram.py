...
from kommunitas.constants import DUST_PER_COIN
from kommunitas.enums import RPCMessageType
from kommunitas.exceptions import OperationalException
from kommunitas.misc import chunks, plural, round_coin_value
from kommunitas.rpc import RPC, RPCException, RPCHandler
...
class Telegram(RPCHandler):
    ...
    def _show_config(self, update: Update, context: CallbackContext) -> None:
        ...
        :return: None
        """
        val = RPC._rpc_show_config(self._config, self._rpc._kommunitas.state)
