...
from kommunitas.constants import ListPairsWithTimeframes
from kommunitas.data.dataprovider import DataProvider
from kommunitas.enums import SellType, SignalTagType, SignalType
...
from kommunitas.exchange.exchange import timeframe_to_next_date
from kommunitas.persistence import PairLocks, Trade
from kommunitas.strategy.hyper import HyperStrategyMixin
...
class IStrategy(ABC, HyperStrategyMixin):
    """
    Interface for kommunitas strategies
...
###
    ...
    def unlock_pair(self, pair: str) -> None:
        ...
        Not used by kommunitas itself, but intended to be used if users lock pairs
