...
from kommunitas.constants import LAST_BT_RESULT_FN
from kommunitas.data.btanalysis import (BT_DATA_COLUMNS, BT_DATA_COLUMNS_MID, BT_DATA_COLUMNS_OLD,
                                       ...
                                       load_trades_from_db)
from kommunitas.data.history import load_data, load_pair_history
...
def test_get_latest_backtest_filename(testdatadir, mocker):
    ...
    mocker.patch("kommunitas.data.btanalysis.json_load", return_value={})
...
def test_load_trades_from_db(default_conf, fee, mocker):
    ...
    init_mock = mocker.patch('kommunitas.data.btanalysis.init_db', MagicMock())
...
def test_load_trades(default_conf, mocker):
    db_mock = mocker.patch("kommunitas.data.btanalysis.load_trades_from_db", MagicMock())
    bt_mock = mocker.patch("kommunitas.data.btanalysis.load_backtest_data", MagicMock())
