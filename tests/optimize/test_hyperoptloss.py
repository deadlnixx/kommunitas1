...
from kommunitas.optimize.default_hyperopt_loss import ShortTradeDurHyperOptLoss
from kommunitas.resolvers.hyperopt_resolver import HyperOptLossResolver
...
def test_hyperoptlossresolver(mocker, default_conf) -> None:
    ...
    mocker.patch(
        'kommunitas.resolvers.hyperopt_resolver.HyperOptLossResolver.load_object',
