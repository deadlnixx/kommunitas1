...
from kommunitas.constants import DATETIME_PRINT_FORMAT, LAST_BT_RESULT_FN
from kommunitas.data import history
from kommunitas.data.btanalysis import get_latest_backtest_filename, load_backtest_data
from kommunitas.edge import PairInfo
from kommunitas.enums import SellType
from kommunitas.optimize.optimize_reports import (generate_backtest_stats, generate_daily_stats,
...
def test_store_backtest_stats(testdatadir, mocker):
    ...
    dump_mock = mocker.patch('kommunitas.optimize.optimize_reports.file_dump_json')
